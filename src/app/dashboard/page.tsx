    ...
    const mockTickets: Ticket[] = [
      {
        ...
        message:
          "When I try to login on my iPhone, the button does not respond. I have to tap it multiple times.",
        status: "in_progress",
        priority: "high",
        ...
        comments: [
          {
            ...
            author: "Support Team",
            message:
              "We are looking into this issue. Can you confirm which iOS version you are using?",
          ...
          },
          {
            id: 2,
            author: "John Doe",
            message: "I am using iOS 17.2 on iPhone 14 Pro",
      ...
      },
      {
        ...
        message:
          "It would be great to have a dark mode option for the dashboard. Working late at night hurts my eyes.",
        status: "pending",
        priority: "medium",
      ...
      },
      {
        id: "TKT-003",
        category: "question",
        subject: "How to export reports in PDF format?",
        message:
          "I need to export my monthly reports in PDF format but cannot find the option. Where is it located?",
        status: "resolved",
        priority: "low",
        created_at: "2024-01-10T16:45:00Z",
        updated_at: "2024-01-11T10:00:00Z",
        video_url: null,
        screenshot_urls: ["https://example.com/img3.jpg"],
        ...
        comments: [
          {
            ...
            author: "Support Team",
            message:
              'You can export reports by clicking the "Export" button at the top right of the reports page.',
